  ...
  return (
    <DiagnosisShell
      ...
      emotionMap={{
        ...
        'senmonka': { feature: '税理士：相続税申告・財産評価', reason: '専門家が必要な手続きが残っている状況です。相続税の申告は10ヶ月以内という期限があります。財産総額が3,600万円を超える場合は申告が必要です。', pitfall: '「専門家に頼むとお金がかかる」という思い込みがありますが、間違った申告で余計な税を払う方が損です。', firstStep: 'まず税理士に「相続税の申告が必要かどうか」だけでも無料相談してみましょう。' },
        'junbi': { feature: '遺言書で家族のもめごとを防げる', reason: '事前準備が整っている状況です。環境の変化（財産の増減・家族構成の変化）があったときは遺言書・財産一覧を更新しましょう。', pitfall: '遺言書の保管場所を家族が知らないと意味がありません。公正証書遺言なら法務局に保管できます（自筆証書遺言書保管制度）。', firstStep: '年1回、財産一覧と遺言書の内容を見直す習慣をつけましょう。' },
      }}
      roadmapByType={{
